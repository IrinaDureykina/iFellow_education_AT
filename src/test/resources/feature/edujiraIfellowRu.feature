...
Feature: ifellowEduJiraTest
  ...
  Scenario: Авторизация
    ...
    Then Сверяем имя профиля с "login"

  @openProjectTest
  Scenario: Заходим в проект и выводим количество задач в проекте
    When Вводим "login" вводим "password" и нажимаем Войти
    Then Заходим в проект и выводим количество задач в проекте
